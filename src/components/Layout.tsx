...
const navItems = [
  ...
  { to: "/memorize", label: "양식", Icon: IconMemorize },
...
export default function Layout() {
  ...
  const isHymnPlayerPage =
    location.pathname.startsWith("/player/") ||
    location.pathname.startsWith("/hymn/player/");
  const isPlayerPage =
    isHymnPlayerPage || location.pathname.startsWith("/sermon/player/");
  ...
  useEffect(() => {
    ...
    if (!isPlayerPage || mediaMode !== "video") {
      setVideoRect(null);
      return;
    }
    const update = () => {
    ...
    <div className="flex min-h-dvh" style={{ background: "var(--surface-0)" }}>
      ...
      <div className="flex flex-col flex-1 min-w-0 lg:ml-[240px]">
        ...
        <main
          className="flex-1"
          style={
            { ["--font-scale" as string]: fontScale } as React.CSSProperties
          }
        >
          <Outlet />
          ...
          >
            <MiniPlayer
              onDismiss={() => {
                ...
                if (currentVideo) {
                  cancelDownload(currentVideo.id, "audio");
                  cancelDownload(currentVideo.id, "video");
                }
                stop();
            ...
            <div
              ...
              style={{
                ...
                transform: fabOpen
                  ...
                  : "translateY(16px) scale(0.85)",
                transition:
                  "opacity 160ms ease 40ms, transform 160ms ease 40ms",
                pointerEvents: fabOpen ? "auto" : "none",
                gap: 8,
              }}
            >
                ...
                style={{
                  ...
                  background:
                    queueIds.length > 0
                      ...
                      : "rgba(255,255,255,0.55)",
                  color:
                    queueIds.length > 0 ? "var(--primary-700)" : "var(--ink-3)",
                  boxShadow: "0 2px 8px rgba(0,0,0,0.12)",
                  flexShrink: 0,
        ...
        <QueuePanel
          isOpen={queueOpen}
          onClose={() => useQueueStore.setState({ isOpen: false })}
        />
            ...
            return (
              ...
              >
                <div className="relative">
                  ...
                  {item.beta && (
                    <span
                      className="absolute -top-1.5 -right-4 text-[8px] font-bold px-1 rounded-full"
                      style={{
                        background: "#FEF3C7",
                        color: "#D97706",
                        lineHeight: fs(14),
